...
const ActionCard: React.FC<{
    ...
    <button
        onClick={onClick}
        className="bg-white dark:bg-[#3a475b] text-slate-800 dark:text-slate-100 rounded-2xl shadow-lg border border-slate-200/50 dark:border-slate-700 p-6 flex flex-col items-center text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
    >
...
const ProductManagementDashboard: React.FC = () => {
    ...
    return (
        <>
            <p className="text-center text-slate-500 dark:text-slate-400 mb-6 -mt-2">Selecione uma opção para começar a gerenciar.</p>
